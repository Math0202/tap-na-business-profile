...
var TABLE_ORIGIN = "https://redirct.link";
var PERSONAL_ORIGIN = "https://cards.redirct.link";
var CORS_HEADERS = {
...
<body style="font-family:Arial,sans-serif;color:#111;line-height:1.5;max-width:560px;margin:0 auto;padding:24px;">
  ...
  <p style="font-size:12px;color:#777;margin:0;">This is a quote request from the tap-na shop. Reply to confirm stock, delivery, and payment.</p>
    ...
    if (!resendRes.ok) {
      const detail = resendData?.message || resendData?.error?.message || (typeof resendData?.error === "string" ? resendData.error : null) || `Resend HTTP ${resendRes.status}`;
